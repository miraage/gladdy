...
if (GetLocale() == "ruRU") then
    ...
    L["Trinket Used Enemy 1"] = "Использование пвп-тринкета целью 1"
    L["Trinket Used Enemy 2"] = "Использование пвп-тринкета целью 2"
    L["Trinket Used Enemy 3"] = "Использование пвп-тринкета целью 3"
    L["Trinket Used Enemy 4"] = "Использование пвп-тринкета целью 4"
    L["Trinket Used Enemy 5"] = "Использование пвп-тринкета целью 5"
...
elseif (GetLocale() == "deDE") then
    ...
    L["Trinket Used Enemy 1"] = "Insiginie Benutzt Gegner 1"
    L["Trinket Used Enemy 2"] = "Insiginie Benutzt Gegner 2"
    L["Trinket Used Enemy 3"] = "Insiginie Benutzt Gegner 3"
    L["Trinket Used Enemy 4"] = "Insiginie Benutzt Gegner 4"
    L["Trinket Used Enemy 5"] = "Insiginie Benutzt Gegner 5"
